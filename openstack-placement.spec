...
Source0:          https://tarballs.openstack.org/placement/%{tarsources}-%{upstream_version}.tar.gz
Source1:          placement-dist.conf
Source2:          placement.logrotate
Source3:          placement-api.conf
# Required for tarball sources verification
%if 0%{?sources_gpg} == 1
Source101:        https://tarballs.openstack.org/placement/%{tarsources}-%{upstream_version}.tar.gz.asc
...
# REMOVEME: error caused by commit https://opendev.org/openstack/placement/commit/efc966764ed1a1e87ca5a755d5c5d127a848c638
